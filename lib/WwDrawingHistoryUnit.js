...
const WwDrawingHistoryDataTranslator_1 = require("./WwDrawingHistoryDataTranslator");
class WwDrawingHistoryUnit {
    ...
    addCommand(_command, adjust_time_to_unit_time = true, link_prev_command = true) {
        ...
        if (this.prevCommand) {
            let point_distance = Point_1.default.distance(this.prevCommand.location, _command.location);
    ...
    updateBoundingRect(command) {
        if (!this.boundingRect) {
            this.boundingRect = new Rect_1.default(command.location.y, command.location.x, 0, 0);
    ...
    get json() {
        ...
        var _commands = [];
        var dataTranslator = new WwDrawingHistoryDataTranslator_1.default();
 ...
 */
//# sourceMappingURL=WwDrawingHistoryUnit.js.map