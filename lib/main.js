...
var _imagesDrw_1440163114487_base_ALLJson = require('../images/drw_1440163114487_base_ALL.json');

var _imagesDrw_1440163114487_base_ALLJson2 = _interopRequireDefault(_imagesDrw_1440163114487_base_ALLJson);
...
var eye_sprite = new _wwSprite2['default'](0, 0);
...
function onBrushesLoaded(brushes) {
    ...
    */
    ...
    historyLoader.parseDrawingData(_imagesDrw_1440163114487_base_ALLJson2['default']);
