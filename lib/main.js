...
var _imagesDrw_1432293328691_base_ALLJson = require('../images/drw_1432293328691_base_ALL.json');

var _imagesDrw_1432293328691_base_ALLJson2 = _interopRequireDefault(_imagesDrw_1432293328691_base_ALLJson);
...
function onBrushesLoaded(brushes) {
    ...
    var history = new _wwDrawingHistoryJs2['default']();
    var base_command = new _wwDrawingHistoryBrushCommand2['default']('hard', new _point2['default'](0, 0));

    _imagesDrw_1432293328691_base_ALLJson2['default'].units.forEach(function (unit_data) {
    ...
    var renderer = new _wwDrawingHistoryRendererJs2['default'](history, ctx);
