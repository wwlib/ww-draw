...
class WwDrawingHistoryBrushCommand {
    ...
    get brush() {
        this._brush = WwDrawingBrushManager_1.default.instance.getBrushFromBrushId(this._brushId);
        if (this._brush) {
    ...
    updateX(value) {
        if (!this._location) {
            this._location = new Point_1.default(0, 0);
        }
        if (value) {
    ...
    static clone(_command, data_object = null) {
        var _clone = new WwDrawingHistoryBrushCommand(_command.brushId, new Point_1.default(_command.location.x, _command.location.y));
