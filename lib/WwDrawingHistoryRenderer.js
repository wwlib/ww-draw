...
class WwDrawingHistoryRenderer {
    constructor(history, context, bounding_rect = null, center_drawing = false, scale = null, start_time = 0, end_time = 0) {
        ...
        if (this.boundingRect && this.mergedCommandsUnit && this.mergedCommandsUnit.boundingRect) {
            ...
            try {
                this.offset = new Point_js_1.default(this.boundingRect.left - this.mergedCommandsUnit.boundingRect.left, this.boundingRect.top - this.mergedCommandsUnit.boundingRect.top);
    ...
    renderCommand(command) {
        ...
        if (command.prevCommand) {
            ...
            for (let i = draw_steps; i > 0; i--) {
                ...
                let temp_command = WwDrawingHistoryBrushCommand_1.default.clone(command);
                let temp_point = Point_js_1.default.interpolate(command.prevCommand.location, command.location, interpolationFactor);
...
//# sourceMappingURL=WwDrawingHistoryRenderer.js.map