...
const WwRenderTextureContext_1 = require("./WwRenderTextureContext");
/**
...
class WwSprite {
    ...
    draw(context) {
        ...
        else if (context instanceof WwRenderTextureContext_1.default) {
 ...
 */
//# sourceMappingURL=WwSprite.js.map