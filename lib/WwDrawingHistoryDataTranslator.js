...
class WwDrawingHistoryDataTranslator {
    constructor() {
        this.previousCommandData = new WwDrawingHistoryBrushCommand_1.default("", null, 1, 0, 0, 0, "", 0, -1, "", false);
        this.drawingScale = 1.0;
    }
    generateCommandWithDataObject(data_object) {
        let command = new WwDrawingHistoryBrushCommand_1.default("", null);
        ...
        let _scale = WwDeviceInfo_1.default.instance.assetScaleFactor / this.drawingScale; //  1.0;  // 0.5 for iPad 2
        command.location = new Point_1.default(_x * _scale, _y * _scale);
        return command;
    }
...
*/
//# sourceMappingURL=WwDrawingHistoryDataTranslator.js.map